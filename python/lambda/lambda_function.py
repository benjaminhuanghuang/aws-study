...
def lambda_handler(event, context):
  ...
  try:
    s3.Bucket(output_s3_bucket).upload_file(json_local_file, 'final-outputpayroll.json')
  except Exception as e:
    print(e)
    print('Error uploading object {} to bucket {}. Make sure the file pathsare correct.'.format(key, bucket_name))
    raise e
